...
const sidebars: SidebarsConfig = {
  agenticSidebar: [
    ...
    { type: 'doc', id: '08-agentic-rag',        label: '8 · Agentic RAG: When Retrieval and Agency Interleave' },
    { type: 'doc', id: '09-rag-evaluation',     label: '9 · RAG Evaluation: Metrics That Survive Production' },
    { type: 'doc', id: '10-rag-cost-security',  label: '10 · RAG Cost, Latency, and Security' },
